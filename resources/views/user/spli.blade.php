...
<br><br>
    ...
    <div class="container alert alert-elevate alert-light alert-bold" style="border: 2px solid #ffb822 ;box-shadow: 0 0 0 rgba(204,169,44, 0.4); animation: pulse 1s infinite;">
        <nav class="nav nav-pills">
            ...
            <span style="padding-left: 150px;"><a style="background-color: #02275d;border-radius: 15px 50px 30px 5px;" class="nav-link active text-light" href="{{ url('spli') }}"><strong>Late Input</strong></a></span>
