...
<div class="container" style="background-color: #ffb822;">
	<div class="container text-dark text-center"><strong style="font-size: 25px;">CREATE NPK LANJUTAN</strong></div>
		...
		<!-- <div class="form-row"> -->
			<div class="form-group">
	      	...
	      	<div class="form-group">
	        	...
	        	<input id="customer_name" type="text" name="customer_name" class="form-control" value="{{ $data->customer_name }}" required>
	      	...
	      	<div class="form-group">
	        	...
	        	<input id="account_number" type="text" name="account_number" class="form-control" value="{{ $data->account_number }}" onchange="getSegmen(this)" required>
	        	<span id="load"></span>
	      	...
	      	<div class="form-group">
			    ...
			    <input type="text" id="segmen" name="segmen" class="form-control" value="{{ $data->segmen }}" placeholder="SEGMEN">
	      	...
	      	<div class="form-group">
	        	...
	        	<input id="manager_name" type="text" name="manager_name" class="form-control" value="{{ $data->manager_name }}" required>
	      	...
	      	<div class="form-group">
	        	...
	        	<input id="nik" type="text" name="nik" class="form-control" value="{{ $data->nik }}" required>
	      	...
	      	<div class="form-group">
	        	...
	        	<input id="jangka_waktu_kontrak" onkeyup="jangka_waktu()" type="text" name="jangka_waktu_kontrak" class="form-control" value="{{ $data->npk_month }}" required>
	      	...
	      	<div class="form-group">
	        	...
	        	<input id="nk" type="text" class="form-control" value="{{ 'Rp. '.number_format($data->nilai_kontrak) }}" required>
	      	...
	      	<div class="form-row">
	      		<div class="form-group col-md-6">
              		...
              		<input id="awal_kontrak" type="text" name="awal_kontrak" class="form-control input-date" value="{{ $data->awal_kontrak }}" required>
	      		...
	      		<div class="form-group col-md-6">
              		...
              		<input id="akhir_kontrak" type="text" name="akhir_kontrak" class="form-control input-date" value="{{ $data->akhir_kontrak }}" required>
			...
			<div class="form-row">
				<div class="form-group col-md-6">
                    ...
                    <input id="periode_bulan" type="text" name="periode_bulan" class="form-control input-datee" value="{{ $data->periode }}" required>
			...
			<div class="form-group">
          	...
          	<div class="form-group">
            	...
            	<input id="tanggal_npk" type="text" name="tanggal_npk" class="form-control input-date"  value="{{ $data->tanggal_npk }}" required><div class="invalid-feedback" style="font-size: 15px;">Isikan Tanggal NPK.</div>
          	</div>
          	<div class="form-row">
          		<div class="form-group col-md-6">
          			<label for="npk_ke">Npk-ke (<i style="color: red;" class="fa fa-asterisk"></i>)</label>
                    <input id="npk_ke" type="text" name="npk_day" class="form-control" value="<?php if ($data->npk_day=='0'): ?>
                    	{{ 1 }}
                    <?php else: ?>
                    	{{ $data->npk_day + 1 }}
                    <?php endif ?>">
          		...
          		<div class="form-group col-md-6">
                    ...
                    <input id="npk_month" type="text" name="npk_month" class="form-control"  value="{{ $data->npk_month }}" required>
                    <div class="invalid-feedback" style="font-size: 15px;">Isikan Dari Jangka Waktu.</div>
          		</div>
          	</div>
          	<div class="form-group">
            	<label for="keterangan">Keterangan</label>
            	<input id="keterangan" type="text" name="keterangan" class="form-control"  value="{{ $data->keterangan }}" required>
            	<div class="invalid-feedback" style="font-size: 15px;">Isikan Keterangan.</div>
          	</div>
          	<div class="form-row">
				<div class="form-group">
					<label for="status">Status Kontrak</label>
					<input type="radio" name="status" value="Selesai"> <span><strong>Selesai</strong></span>
				</div>
			</div>
          	<div class="form-row">
