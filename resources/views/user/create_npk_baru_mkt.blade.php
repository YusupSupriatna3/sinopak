...
<div class="container" style="background-color: #ffb822;">
	<div class="container text-dark text-center"><strong style="font-size: 25px;">CREATE NPK BARU MARKETING</strong></div>
		...
		<!-- <div class="form-row"> -->
			<div class="form-group">
	      	...
	      	<div class="form-group">
	        	...
	        	<input id="periode" type="text" name="periode" class="form-control" required>
          	...
          	<div class="form-group">
				...
				<button type="submit" name="create-npk-baru-mkt" style="background-color: #02275d;bottom: 20px;" class="btn btn-primary col-md-12 text-light"><i class="fa fa-pencil"></i> Create</button>
			</div>
		<!-- </div> -->
	</form>
</div>
